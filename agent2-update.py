...
_default_instructions = (
    ...
    "2. Thông báo khoản nợ là xxx đồng đã quá hạn thanh toán và yêu cầu khách thanh toán trước ngày dd tháng mm năm yyyy.. "
    ...
    "   - Nếu khách chưa thể thanh toán đúng hạn, hãy hỏi xem khách có thể thanh toán vào ngày nào (định dạng dd/mm/yyyy). "
    ...
    "Sau khi kết thúc cuộc gọi, tổng hợp lại toàn bộ thông tin và gọi API webhook để báo cáo kết quả cuộc gọi."
)
# _default_instructions = (
...
async def entrypoint(ctx: JobContext):
    ...
    instructions = (
        ...
        + "Sau khi kết thúc cuộc gọi, bạn cần tổng hợp kết quả thông tin của khách hàng và gọi API webhook để báo cáo kết quả cuộc gọi. "
...
def run_voice_pipeline_agent(
    ...
    asyncio.create_task(agent.say(f"Xin chào, tôi là Hùng từ công ty Di Mô. Tôi đang nói chuyện với {address} {customer_name} phải không ạ?", allow_interruptions=False))
